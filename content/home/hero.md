...
<style>
  ...
  .emlab .station{background:var(--card); border:1px solid var(--border); border-radius:12px; padding:20px 18px; display:block; position:relative; overflow:hidden; transition:box-shadow 0.3s, background 0.3s;}
  ...
  .emlab .ribbon-complete{position:absolute; top:0; right:0; background:var(--green); color:#04211D; font-size:10.5px; font-weight:800; letter-spacing:0.04em; padding:6px 12px 6px 16px; border-radius:0 0 0 12px; display:none; align-items:center; gap:5px;}
